...
# a function to apply insertion sort algorithm on the above list.
def ExecuteInsertionSort(prm_ls):
...
sorted_ls = ExecuteInsertionSort(original_ls)
print('After applying the Insertion Sort :')
print(sorted_ls)